 ...
 *   The form state.
 */
function ascentbuild_form_system_theme_settings_alter(&$form, &$form_state) {
 ...
 $form['mtt_settings']['tabs']['responsive_menu']['responsive_menu_state'] = array(
	...
	'#default_value' => theme_get_setting('responsive_menu_state', 'ascentbuild'),
  );
 ...
 $form['mtt_settings']['tabs']['responsive_menu']['responsive_menu_switchwidth'] = array(
	...
	'#default_value' => theme_get_setting('responsive_menu_switchwidth', 'ascentbuild'),
  );
  ...
  $form['mtt_settings']['tabs']['responsive_menu']['responsive_menu_topoptiontext'] = array(
	...
	'#default_value' => theme_get_setting('responsive_menu_topoptiontext', 'ascentbuild'),
  );
